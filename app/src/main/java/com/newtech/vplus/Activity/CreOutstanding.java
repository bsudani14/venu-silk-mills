...
public class CreOutstanding extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new showpdf().execute("http://" + BuildConfig.REPORT_SERVER_IP + ":83/CreOutstaning_Report/Viewsaleout?todate="+tdate+"&type=" + khataname + "&brcode=" + brcode);
        new DownloadFile().execute("http://" + BuildConfig.REPORT_SERVER_IP + ":83/CreOutstaning_Report/Viewsaleout?todate="+tdate+"&type=" + khataname + "&brcode=" + brcode, brcode + ".pdf");
