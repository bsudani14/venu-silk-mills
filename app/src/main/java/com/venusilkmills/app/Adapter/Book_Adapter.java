...
public class Book_Adapter extends RecyclerView.Adapter<Book_Adapter.ViewHolder> {
    private List<BookClass> department_data_list = new ArrayList<BookClass>();
    private List<BookClass> department_data_list1 = new ArrayList<BookClass>();
    Context context;
    private OnItemClickListener listener;
    int pos;

    public interface OnItemClickListener {
        void onItemClick(BookClass dpm1);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final BookClass dpm1, final OnItemClickListener listener) {
    ...
    public Book_Adapter(List<BookClass> department_data_lists, Context context, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        this.pos = position;
        BookClass pa = department_data_list.get(pos);
        holder.pd_name.setText(pa.getBookname());
    ...
    public void filter(String charText) {
        ...
        if (charText.length() == 0) {
            ...
            for (BookClass wp : department_data_list1) {
